...
// Copyright (C) 2005 - 2009, 2019, 2021. Charles W. Rapp.
// All Rights Reserved.
//
// Contributor(s):
...
//
 ...
 and the package name.
    ...
    private void outputExecuteAction()
    {
        ...
        // Allow runtime exceptions to bubble up to the
        // application layer since this matches -java code.
        ...
        mTarget.println("        {");
        mTarget.println("            debugOutput(tex);");
        mTarget.println();
        mTarget.println("            if (RuntimeException.class.isInstance(tex))");
        mTarget.println("            {");
        mTarget.println("                throw ((RuntimeException) tex);");
        mTarget.println("            }");
        mTarget.println("        }");
        mTarget.println("    }");
        mTarget.println();
                                 ...
                                 final String stateName)
    {
        ...
        {
            mTarget.print(mIndent);
            mTarget.print("debugOutput(\"LEAVING STATE   : ");
            mTarget.print(mapName);
            mTarget.print('.');
            mTarget.print(stateName);
            mTarget.println("\");");
        ...
        {
            mTarget.print(mIndent);
            mTarget.print("debugOutput(\"BEFORE EXIT     : ");
            mTarget.print(stateName);
        ...
        {
            mTarget.print(mIndent);
            mTarget.print("debugOutput(\"AFTER EXIT      : ");
            mTarget.print(stateName);
            mTarget.println(".exit()\");");
            mTarget.println();
        }
                                       ...
                                       final String stateName)
    {
        ...
        if (mDebugLevel >= DEBUG_LEVEL_0)
        {
            ...
            mTarget.print(mIndent);
            mTarget.print("    debugOutput(\"ENTER TRANSITION: ");
            mTarget.print(mapName);
            mTarget.print('.');
            mTarget.print(stateName);
            mTarget.print('.');
                                  ...
                                  final String stateName)
    {
        if (mDebugLevel >= DEBUG_LEVEL_1)
        {
            mTarget.println();
            mTarget.print(mIndent);
            mTarget.print("debugOutput(\"BEFORE ENTRY    : ");
            mTarget.print(stateName);
        ...
        if (mDebugLevel >= DEBUG_LEVEL_1)
        {
            mTarget.println();
            mTarget.print(mIndent);
            mTarget.print("debugOutput(\"AFTER ENTRY     : ");
            mTarget.print(stateName);
            mTarget.println(".entry()\");");
        }
