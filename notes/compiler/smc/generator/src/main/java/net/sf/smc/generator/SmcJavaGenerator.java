...
//
    ...
    public void visit(SmcFSM fsm)
    {
        ...
        mTarget.println("    {");
        mTarget.println("        if (mState == null)");
        mTarget.println("        {");
        mTarget.println(
            "            throw(");
        mTarget.println(
        ...
        if (mReflectFlag)
        {
            ...
            mTarget.println("    {");
            mTarget.println("        return (mTransitions);");
            mTarget.println("    }");
            mTarget.println();
        }
        ...
        mTarget.println("//");
        mTarget.println();
        mTarget.print("    private transient ");
        mTarget.print(context);
        mTarget.println(" mOwner;");

        // If reflection is turned on then declare the transition set.
        if (mReflectFlag)
        {
            mTarget.println();
            mTarget.print("    private final Set");
            if (mGenericFlag)
            {
                mTarget.print("<String>");
            }
            mTarget.println(" mTransitions;");
        }
        ...
        if (mSerialFlag || mReflectFlag)
        {
            ...
            mTarget.println("    //");
            mTarget.println();
            mTarget.print("    private static transient ");
            mTarget.print(context);
            mTarget.println("State[] sStates =");
            mTarget.println("    {");
        ...
        {
            mTarget.println(
                "            context.debugOutput(\"TRANSITION   : Default\");");
            mTarget.println();
        }
...
//         mTarget.println();
        ...
        */
        ...
        if (mReflectFlag)
        {
            ...
            mTarget.println("        {");
            mTarget.print("            ");
            mTarget.print("sTransitions = new HashMap");
            if (mGenericFlag)
            {
                if (mJava7Flag)
                {
            ...
            for (SmcTransition transition: allTransitions)
            {
                ...
                mTarget.print("            ");
                mTarget.print("sTransitions.put(\"");
                mTarget.print(transName);
                mTarget.print("\", ");
    ...
    public void visit(SmcState state)
    {
        ...
        if (mReflectFlag)
        {
            ...
            mTarget.println("        {");
            mTarget.print("            ");
            mTarget.println("return (sTransitions);");
            mTarget.println("        }");
            mTarget.println();
        }
    ...
    public void visit(SmcTransition transition)
    {
        ...
        if (mDebugLevel >= DEBUG_LEVEL_0)
        {
            mTarget.print(mIndent);
            mTarget.print(
                "    context.debugOutput(\"LEAVING STATE   : ");
            mTarget.print(mapName);
            mTarget.print('.');
            mTarget.print(stateName);
            mTarget.println("\");");
    ...
    public void visit(SmcGuard guard)
    {
            ...
            loopbackFlag == false)
        {
            if (mDebugLevel >= DEBUG_LEVEL_1)
            {
                mTarget.print(indent2);
                mTarget.print(
                    "context.debugOutput(\"BEFORE EXIT     : ");
                mTarget.print(stateName);
            ...
            if (mDebugLevel >= DEBUG_LEVEL_1)
            {
                ...
                mTarget.print(indent2);
                mTarget.print(
                    "context.debugOutput(\"AFTER EXIT      : ");
                mTarget.print(stateName);
                mTarget.println(".exit(context)\");");
                mTarget.println();
            }
        ...
        if (mDebugLevel >= DEBUG_LEVEL_0)
        {
            ...
            mTarget.print(mIndent);
            mTarget.print(
                "context.debugOutput(\"ENTER TRANSITION: ");
            mTarget.print(stateName);
            mTarget.print('.');
            mTarget.print(transName);
        ...
        if (mDebugLevel >= DEBUG_LEVEL_0)
        {
            ...
            mTarget.print(mIndent);
            mTarget.print(
                "context.debugOutput(\"EXIT TRANSITION : ");
            mTarget.print(stateName);
            mTarget.print('.');
            mTarget.print(transName);
             ...
             transType == TransType.TRANS_PUSH)
        {
            if (mDebugLevel >= DEBUG_LEVEL_1)
            {
                ...
                mTarget.print(indent3);
                mTarget.print(
                    "context.debugOutput(\"BEFORE ENTRY    : ");
                mTarget.print(fqEndStateName);
            ...
            if (mDebugLevel >= DEBUG_LEVEL_1)
            {
                ...
                mTarget.print(indent3);
                mTarget.print(
                    "context.debugOutput(\"AFTER ENTRY     : ");
                mTarget.print(fqEndStateName);
                mTarget.println(".entry(context)\");");
            }
        }
    ...
    {
        mTarget.print("        mTransitions = new TreeSet");
        if (mGenericFlag)
        {
                if (mJava7Flag)
                {
        ...
        for (SmcTransition trans: transitions)
        {
            mTarget.print("        mTransitions.add(\"");
            mTarget.print(trans.getName());
            mTarget.println("\");");
        }
