...
//
    ...
    {
        _transition = "something";
        getState().something(this);
        _transition = "";
        return;
    }
...
//
    ...
    //
        ...
        protected void coin(TurnstileContext context, int x)
        {
            Default(context);
        }
        ...
        protected void something(TurnstileContext context)
        {
            Default(context);
        }
    ...
    //
        ...
        protected void entry(TurnstileContext context)
            ...
            ctxt.System.out.prinln("entered");
            return;
        }
        ...
        protected void Default(TurnstileContext context)
        {
            ...
            try
            {
                ctxt.System.out.println("hello world");
            }
            finally
            {
