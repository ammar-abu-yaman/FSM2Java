...
public class compilerParser extends Parser {
	...
	public static final int T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, T__6 = 7, T__7 = 8, T__8 = 9,
			...
			JAVA_CODE = 18;
	public static final int RULE_program = 0, RULE_option = 1, RULE_state_block = 2, RULE_state = 3,
	...
	public static class ProgramContext extends ParserRuleContext {
		...
		public TerminalNode EOF() {
			return getToken(compilerParser.EOF, 0);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof compilerVisitor)
				return ((compilerVisitor<? extends T>) visitor).visitProgram(this);
			else
	...
	public static class OptionContext extends ParserRuleContext {
		...
		public TerminalNode OP_ID() {
			return getToken(compilerParser.OP_ID, 0);
		}

		public List<TerminalNode> ID() {
			return getTokens(compilerParser.ID);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof compilerVisitor)
				return ((compilerVisitor<? extends T>) visitor).visitOption(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class State_blockContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_state_block;
		}

		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof compilerVisitor)
				return ((compilerVisitor<? extends T>) visitor).visitState_block(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class StateContext extends ParserRuleContext {
		...
		public TerminalNode ID() {
			return getToken(compilerParser.ID, 0);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof compilerVisitor)
				return ((compilerVisitor<? extends T>) visitor).visitState(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class Enter_blockContext extends ParserRuleContext {
		...
		public TerminalNode JAVA_CODE() {
			return getToken(compilerParser.JAVA_CODE, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_enter_block;
		}

		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof compilerVisitor)
				return ((compilerVisitor<? extends T>) visitor).visitEnter_block(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class Exit_blockContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_exit_block;
		}

		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof compilerVisitor)
				return ((compilerVisitor<? extends T>) visitor).visitExit_block(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class TransitionContext extends ParserRuleContext {
		...
		public TerminalNode GUARD() {
			return getToken(compilerParser.GUARD, 0);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof compilerVisitor)
				return ((compilerVisitor<? extends T>) visitor).visitTransition(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class TriggerContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof compilerVisitor)
				return ((compilerVisitor<? extends T>) visitor).visitTrigger(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class Param_listContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof compilerVisitor)
				return ((compilerVisitor<? extends T>) visitor).visitParam_list(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class ParamContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof compilerVisitor)
				return ((compilerVisitor<? extends T>) visitor).visitParam(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class Type_idContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof compilerVisitor)
				return ((compilerVisitor<? extends T>) visitor).visitType_id(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN = "\u0004\u0001\u0012x\u0002\u0000\u0007\u0000\u0002\u0001\u0007\u0001\u0002"
			+
			"\u0002\u0007\u0002\u0002\u0003\u0007\u0003\u0002\u0004\u0007\u0004\u0002" +
			"\u0005\u0007\u0005\u0002\u0006\u0007\u0006\u0002\u0007\u0007\u0007\u0002" +
			"\b\u0007\b\u0002\t\u0007\t\u0002\n\u0007\n\u0001\u0000\u0005\u0000\u0018" +
